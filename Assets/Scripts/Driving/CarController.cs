...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_Topspeed = 160;
        ...
        private void CalculateGearFactor()
        {
            ...
            var targetGearFactor = Mathf.InverseLerp(f*m_carUserControl.marchaAtual, f*(m_carUserControl.marchaAtual  + 1), Mathf.Abs(CurrentSpeed/MaxSpeed));
        ...
        private void CalculateRevs()
        {
            ...
            CalculateGearFactor();
            var gearNumFactor = m_carUserControl.marchaAtual/(float) NoOfGears;
